...
class username_converters:
    ...
    def deviantart_convert(self,url):
    ...
    def furaffinity_convert(self,url):
    ...
    def pixiv_convert(self,url):# TODO
    ...
    def convert(self,url):
        if 'deviantart.com' in url:
            return deviantart_convert(url)
        elif 'furaffinity.net' in url:
            return furaffinity_convert(url)
        elif 'inkbunny.net' in url:
            return inkbunny_convert(url)
        elif '.tumblr.com' in url:
            return tumblr_convert(url)
        elif 'pixiv.net' in url:
            return pixiv_convert(url)
    ...
    for domain_key in link_dict.keys():
        ...
        for output_url in link_dict[domain_key]:
            if domain_key == 'deviantart.com':
                output_username = username_converters.deviantart_convert(output_url)
                output_data += (output_username + '\n')
            elif domain_key == 'furaffinity.net':
                output_username = username_converters.furaffinity_convert(output_url)
                output_data += (output_username + '\n')
            elif domain_key == 'inkbunny.net':
                if '.php' not in output_url:
                    output_username = username_converters.inkbunny_convert(output_url)
                    output_data += (output_username + '\n')
            else:
                output_data += (output_url + '\n')
        print 'output_data', output_data
